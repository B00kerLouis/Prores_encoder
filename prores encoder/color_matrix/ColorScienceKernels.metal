// Decodes source pixels, performs direct color mapping or LUT burn-in, and
// packs encoded RGB into the output pixel-buffer layout.

#include <metal_stdlib>
using namespace metal;

// CPU-mirrored parameters for transfer, gamut, range, and LUT processing.
